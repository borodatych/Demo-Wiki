...
function docReady(){
	...
	$('ul.gallery li').hover(function(){
		var image = "&lt;?php echo $image->id;?&gt;";
		//var image2 = "<?php echo str_replace(\"'\",\"\'\",$image->id);?>";
		$('img',this).fadeToggle(1000);
		$(this).find('.gallery-controls').remove();
		$(this).append('<div class="well gallery-controls">'+
				'<p><a href="" class="gallery-edit btn"><i class="icon-edit"></i></a> '+
				'<a href="" class="gallery-delete btn"><i class="icon-remove"></i></a></p>'+
				'</div>');
	...
	$('.thumbnails').on('click','.gallery-delete',function(e){
		e.preventDefault();
		//get image id
                var image_id = $(this).parents('.thumbnail').attr('id');
		alert(image_id);
