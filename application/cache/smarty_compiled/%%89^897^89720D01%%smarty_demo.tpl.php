<?php /* Smarty version 2.6.26, created on 2013-01-13 13:05:24
         compiled from Z:%5Chome%5Ckohana33%5Cwww%5Cmodules%5Csmarty%5Cviews%5Csmarty_demo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', '__', 'Z:\\home\\kohana33\\www\\modules\\smarty\\views\\smarty_demo.tpl', 63, false),array('modifier', 'htmlspecialchars', 'Z:\\home\\kohana33\\www\\modules\\smarty\\views\\smarty_demo.tpl', 113, false),array('modifier', 'file_get_contents', 'Z:\\home\\kohana33\\www\\modules\\smarty\\views\\smarty_demo.tpl', 118, false),)), $this); ?>
...
<td><?php echo '&lt;strong>Variable:&lt;/strong&gt; {$myvar}'; ?>
</td>
</tr>

<tr>
<td>&lt;strong>Global variable:&lt;/strong&gt; &lt;?php echo $myglobalvar ?&gt;</td>
<td><?php echo '&lt;strong&gt;Global variable:&lt;/strong&gt; {$myglobalvar}'; ?>
</td>
</tr>

<tr>
<td colspan ="2">Demo: <strong>Variable:</strong> <?php echo $this->_tpl_vars['myvar']; ?>
 <strong>Global variable:</strong> <?php echo $this->_tpl_vars['myglobalvar']; ?>
</td>
</tr>


<?php $old_lang = i18n::$lang; i18n::$lang = 'fr-fr'; ?>
<tr><th colspan="2">Translation</th></tr>

<tr>
<td>&lt;?php echo __('Hello, world!') ?&gt;</td>
<td><?php echo '{__ t=\'Hello, world!\'}'; ?>
</td>
</tr>

<tr><td colspan="2">Demo (Kohana language forced to French): <?php echo smarty_function___(array('t' => 'Hello, world!'), $this);?>
</td></tr>
<?php i18n::$lang = $old_lang; ?>
...
<td><?php echo '{__ t=\'Welcome back, :user\' user=$username}'; ?>
</td>
</tr>

<tr><td colspan="2">Demo (no example available in default language files): <?php echo smarty_function___(array('t' => 'Welcome back, :user','user' => $this->_tpl_vars['username']), $this);?>
</td></tr>
...
<p>This module is using Smarty version <?php echo '2.6.26'; ?>
. Compare this with the latest version shown on the Smarty <a href="http://www.smarty.net/download.php">Smarty download page</a>.</p>
...
<pre>
<?php echo ((is_array($_tmp=$this->_tpl_vars['controller'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>

</pre>

<h4>The template file (modules/smarty/views/smarty_demo.tpl)</h4>
<pre>
<?php echo ((is_array($_tmp=((is_array($_tmp='Z:\home\kohana33\www\modules\smarty\views\smarty_demo.tpl')) ? $this->_run_mod_handler('file_get_contents', true, $_tmp) : file_get_contents($_tmp)))) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>

</pre>

<h4>The page layout template file (modules/smarty/views/smarty_demo_page.tpl)</h4>
<pre>
<?php echo ((is_array($_tmp=$this->_tpl_vars['wrapper'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
